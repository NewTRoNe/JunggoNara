	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == upload) {
			...
			else if (contextinput.getText().equals(""))
			{
				...
				JOptionPane.showMessageDialog(null, "게시물 등록 완료");
				setVisible(false);
			}
		}
		else if(obj == img) {
			...
			int selected = JOptionPane.showConfirmDialog(null, "변경 사항이 저장되지 않습니다.", 
					"경고", JOptionPane.YES_NO_OPTION, 
					JOptionPane.WARNING_MESSAGE);
			if (selected == JOptionPane.YES_OPTION) {
				JOptionPane.showMessageDialog(null, "게시물창 이동");
				setVisible(false);
			} else {
				return;
			}
...
//		{
//			JOptionPane.showMessageDialog(null, "최대 글자 수를 초과하였습니다.");
//			e.consume();
//		}
	}
